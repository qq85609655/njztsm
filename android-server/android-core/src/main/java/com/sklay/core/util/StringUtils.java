...
public class StringUtils extends org.springframework.util.StringUtils {
	...
	public static Set<String> findImgSrcs(String htmlString) {
		...
		while (imgMatcher.find()) {
			String src = org.apache.commons.lang.StringUtils
					.trimToNull(imgMatcher.group(1));
			if (src != null) {
	...
	public static void main(String[] args) {
		// <img class="current"
		// src="http://f.any123.com/pagelet/ad/index/Banner1.jpg" />aaa<img
		// src="">
		// <img
		// data-ke-src="http://static.oschina.net/uploads/img/201211/13065445_YtoG.png"
		// src="http://static.oschina.net/uploads/img/201211/13065445_YtoG.png"
		// alt="eXo Platform">
	}
}
