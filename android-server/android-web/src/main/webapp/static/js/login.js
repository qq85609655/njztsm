...
//	SKLAY.modal({"id":"loginModal","header":"Login",onShown:function(){initOnce(this,'login');}});
//	SKLAY.modal({"id":"registModal","header":"Regist",onShown:function(){initOnce(this,'regist');}});
	
	SKLAY.modal({"id":"auditModal","header":"审核",onShown:function(){initOnce(this,'login');}});
});