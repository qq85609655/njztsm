	...
	<#macro loopRenderComment cline row>
		<#if cline*sizePerLine lte comments?size-1>
			...
			<#if currentIndex lt comments?size>
				...
				<#assign step=2>
				<div class="item">
					<a class="item-wrapper" data-target="#ajaxDetail" href="${action}/pushs/detail?newsId=${comment.id}" data-toggle="modal">
			        ...
			        <div class="item-credits">
		        		<a class="user" href="javascript:void(0)"><img src="${ctx}/static/img/user-34.jpg"></a>
