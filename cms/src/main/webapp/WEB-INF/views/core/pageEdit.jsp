...
<form action="${ctx}/page/edit" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="keywords" class="input-xlarge" name="keywords" value="${currentPage.keywords}">
		</div>
	</div>
	<div class="control-group">
		<label for="description" class="control-label">描述</label>
		<div class="controls">
			<input type="text" id="description" class="input-xlarge" name="description" value="${currentPage.description}">
		</div>
	</div>
	<div class="control-group">
		<label for="pageRank" class="control-label">排序</label>
