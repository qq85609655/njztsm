...
public class Widget implements Serializable, Comparable<Widget> {
	...
	@JoinTable(name = "sklay_cms_widget_setting", joinColumns = { @JoinColumn(name = "widget_id") })
	...
	public String toString() {
		return "Widget [id=" + id + ", title=" + title + ", borderTpl="
				+ borderTpl + ", borderClass=" + borderClass + ", pageId="
				+ pageId + ", container=" + container + ", name=" + name
				+ ", settings=" + settings + ", rank=" + rank + ", content="
				+ content + "]";
	}
