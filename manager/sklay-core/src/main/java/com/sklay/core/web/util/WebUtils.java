...
public class WebUtils extends org.springframework.web.util.WebUtils {
	...
	private static final String[] MOBILE_CLIENT_AGENT = { "njztsm.net" };
	...
	public static boolean isAndroidRequest(HttpServletRequest request) {
		String userAgent = request.getHeader("user-agent").toLowerCase();
		for (String mobile : MOBILE_CLIENT_AGENT) {
			if (userAgent.contains(mobile)) {
				return true;
			}
		}
	...
	public static void writeJson(Object result, Writer writer)
			throws IOException {
		writer.write(JSON.toJSONString(result));
	}

	public static void writeToResponse(String result,
