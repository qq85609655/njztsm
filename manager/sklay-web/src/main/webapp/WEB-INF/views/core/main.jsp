...
<!-- html5 -->
<script type="text/javascript" src="${ctx}/static/js/cms/html5.js"></script>
<script src="${rs}/thirdparty/jquery/jquery-1.9.1.min.js"></script>
<script src="${rs}/thirdparty/jquery/jquery-migrate-1.2.1.js"></script>
...
<script src="${rs}/js/cms/base.js"></script>
...
<!-- admin area start-->
<shiro:hasPermission name="admin:cms">
	...
	<script src="${ctx}/static/js/cms/admin.js?ver=${global.ver}"></script>
	<script>
		$(function(){
