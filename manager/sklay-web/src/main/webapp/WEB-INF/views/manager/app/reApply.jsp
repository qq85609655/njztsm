...
<div class="" id="createForm">
	<div class="alert-detail alert-info">
	  <h4>说明!</h4>
	 单价：${model.product.price }元/条 ; ${model.product.description }
	</div>
	<form class="form-horizontal" action="${ctx }/app/reApply" method="post">
	      ...
	      <div class="control-group">
	        ...
	        <div class="controls">
	          	<textarea class="span3" rows="3" cols="5"  name="remark" id="inputRemark" placeholder="备注说明">${model.remark }</textarea>
	        </div>
	      </div>
     </form>
</div>