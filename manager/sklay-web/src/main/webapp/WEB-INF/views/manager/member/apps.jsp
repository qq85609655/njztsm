...
<div class="widget-box">
	...
	<div class="widget-content tab-content">
		...
		<form action="${ctx }/app/page" method="post">
								...
								<tr>
									...
									<c:choose>
										<c:when test="${model.status.value eq 1}">
											<a href="${ctx}/app/${model.id}/used">使用详情</a>	
										</c:when>
										<c:otherwise>
											<a class="modal-link" data-target="#modalTemplate" data-title="重新申请" href="${ctx}/app/${model.id}/reApply">重新申请</a>									
										</c:otherwise>
									</c:choose>
									</td>
								</tr>
