...
public class MedicalReportServiceImpl implements MedicalReportService
{
    ...
    public List<MedicalReport> getLastReports(Long userId, int day)
    {
        ...
        MedicalReport lastReport = specificDao.findLastReport(userId, SMSType.PHYSICAL);
        if (null == lastReport)
            return null;
        ...
        throws SklayException
    {
        ...
        return specificDao.searchMedicalReport(keyword, tipType, readType, user, groups, pageable);
    }
}
