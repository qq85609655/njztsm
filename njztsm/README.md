...
> ├ com.njztsm.app<br>
> ├ com.njztsm.app.adapter<br>
> ├ com.njztsm.app.api<br>
> ├ com.njztsm.app.bean<br>
> ├ com.njztsm.app.common<br>
> ├ com.njztsm.app.ui<br>
> └ com.njztsm.app.widget<br>

- com.weibo.net — 新浪微博SDK源码包
- greendroid.widget — 快捷菜单栏组件(国外UI库[GreenDroid](http://www.oschina.net/p/greendroid))
- com.njztsm.app — APP启动及管理包
- com.njztsm.app.adapter — APP列表适配器包
- com.njztsm.app.api — API访问包
- com.njztsm.app.bean — APP实体包
- com.njztsm.app.common — APP工具包
- com.njztsm.app.ui — APP界面包
- com.njztsm.app.widget — APP控件包
...
#### 1、APP启动流程 ####
AndroidManifest.xml注册的启动界面为"AppStart"，具体文件为com.njztsm.app\AppStart.java文件。启动显示欢迎界面之后，通过意图(Intent)跳转到首页（com.njztsm.app.ui\Main.java）。<br>
*注：除启动界面之外，其他所有界面都放在src\com.njztsm.app.ui包中。*
...
*注：Main.xml布局文件在res\layout目录下；PullToRefreshListView控件在com.njztsm.app.widget包；ListViewNewsAdapter适配器在com.njztsm.app.adapter包。*
...
*注：AppContext全局应用程序类在com.njztsm.app包；ApiClient API客户端类在com.njztsm.app.api包。*

**3) 解析数据显示**<br>
服务得到请求，将返回对应的资讯XML数据，再通过资讯实体类(NewsList)解析XML，返回实体(NewsList)给UI控件(PullToRefreshListView)展示。<br>
*注：NewsList实体类在com.njztsm.app.bean包。*
