package com.njztsm.app.adapter;
...
import com.njztsm.app.bean.Comment.Refer;
import com.njztsm.app.bean.Comment.Reply;
import com.njztsm.app.common.BitmapManager;
import com.njztsm.app.common.StringUtils;
import com.njztsm.app.constant.Constants;
import com.njztsm.app.widget.LinkView;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		{	
			default:
				...
				break;
			case Constants.CLIENT_MOBILE:
				listItemView.client.setText("来自:手机");
				break;
			case Constants.CLIENT_ANDROID:
				listItemView.client.setText("来自:Android");
				break;
			case Constants.CLIENT_IPHONE:
				listItemView.client.setText("来自:iPhone");
				break;
			case Constants.CLIENT_WINDOWS_PHONE:
...
//	TODO	Comment comment = (Comment)v.getTag();
