...
public class Messages extends Entity {
	...
	public static Messages parse(InputStream inputStream) throws IOException,
			AppException {
		Messages msg = null;
		// 获得XmlPullParser解析器
				...
				case XmlPullParser.START_TAG:
					if (tag.equalsIgnoreCase("message")) {
						...
						if (tag.equalsIgnoreCase("id")) {
							...
							msg.setFriendId(StringUtils.toInt(
