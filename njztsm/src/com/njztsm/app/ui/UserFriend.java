...
import com.njztsm.app.adapter.ListViewFriendAdapter;
import com.njztsm.app.bean.FriendList;
import com.njztsm.app.bean.FriendList.Friend;
...
public class UserFriend extends BaseActivity {
	...
	private void initView() {
		...
		friend_type_fans.setOnClickListener(this.friendBtnClick(
				friend_type_fans, Constants.Friend.TYPE_FANS));
		friend_type_follower.setOnClickListener(this.friendBtnClick(
				friend_type_follower, Constants.Friend.TYPE_FOLLOWER));

		// 设置当前分类
		curLvCatalog = getIntent().getIntExtra("friend_type",
				Constants.Friend.TYPE_FOLLOWER);
		if (curLvCatalog == Constants.Friend.TYPE_FANS) {
		...
		friend_type_follower.setText(getString(R.string.user_friend_follower,
				followers));
		friend_type_fans.setText(getString(R.string.user_friend_fans, fans));

		lvFriend_footer = getLayoutInflater().inflate(R.layout.listview_footer,
				null);
		lvFriend_foot_more = (TextView) lvFriend_footer
				.findViewById(R.id.listview_foot_more);
		lvFriend_foot_progress = (ProgressBar) lvFriend_footer
				.findViewById(R.id.listview_foot_progress);

		lvFriendAdapter = new ListViewFriendAdapter(this, lvFriendData,
		...
		mlvFriend.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				TextView name = (TextView) view
						.findViewById(R.id.friend_listitem_name);
				...
				// TODO 跳转
				// UIHelper.showUserCenter(view.getContext(),
		...
		mlvFriend.setOnScrollListener(new AbsListView.OnScrollListener() {
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				try {
					if (view.getPositionForView(lvFriend_footer) == view
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				mlvFriend.onScroll(view, firstVisibleItem, visibleItemCount,
						totalItemCount);
			}
		});
		mlvFriend
				.setOnRefreshListener(new PullToRefreshListView.OnRefreshListener() {
					public void onRefresh() {
						loadLvFriendData(curLvCatalog, 0, mFriendHandler,
	...
	private void initData() {
		...
		this.loadLvFriendData(curLvCatalog, 0, mFriendHandler,
	 ...
	 *            动作标识
	 */
	private void loadLvFriendData(final int type, final int pageIndex,
		...
		new Thread() {
			public void run() {
				...
				if (action == UIHelper.LISTVIEW_ACTION_REFRESH
					...
					isRefresh = true;
				try {
					FriendList FriendList = ((AppContext) getApplication())
							.getFriendList(type, pageIndex, isRefresh);
